      ...
      <div className='pb-[5vh] flex flex-col grow justify-start gap-4'>
        ...
        <div>
          ...
          <div className='ml-8'>
            ...
            <p className='mt-1 lg:mt-1.5 sm:text-xl md:text-base lg:text-xl font-medium'>4. 신규 API 연결에 따른 데이터 처리 Batch 개발</p>
            <p className='mt-1 lg:mt-1.5 sm:text-xl md:text-base lg:text-xl font-medium'>5. 개발단 서버 JEUS 컨테이너 관리</p>
            <p className='mt-1 lg:mt-1.5 sm:text-xl md:text-base lg:text-xl font-medium'>6. <b>Apache Jmeter</b>를 사용한 주요 로직 부하테스트</p>
            <p className='mt-1 lg:mt-1.5 sm:text-xl md:text-base lg:text-xl font-medium'>7. AngularJS 기반 모바일 페이지 유지보수</p>
          </div>
        </div>
        <div>
          ...
          <div className='ml-8'>
            ...
            <p className='mt-1 lg:mt-1.5 sm:text-xl md:text-base lg:text-xl font-medium'>2. 신규 외부 API 연결에 문제가 발생하였을 때, 주도적으로 원인을 분석하여 IT현업과 소통하였고, 프로젝트 진행에 차질이 없도록 하였습니다.</p>
            <p className='mt-1 lg:mt-1.5 sm:text-xl md:text-base lg:text-xl font-medium'>3. Javascript를 이용해 간단한 툴을 제작, 팀원들에게 배포하여 업무의 효율을 증가시켰습니다.</p>
